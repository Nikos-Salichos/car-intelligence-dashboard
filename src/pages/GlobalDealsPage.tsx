                ...
                <tr>
                  ...
                  <th className="p-4 text-left">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1 font-semibold hover:text-indigo-600 transition"
                    >
                ...
                <tr className="bg-slate-100/60 border-b border-slate-200">
                  ...
                  <td className="p-2">
                    <input
                      ...
                      value={listingUrlFilter}
                      onChange={(e) => setListingUrlFilter(e.target.value)}
                    />
                  </td>
                  ...
                  <td className="p-2 text-center">
                    <input
                      ...
                      value={minVfm}
                      onChange={(e) =>
                        setMinVfm(Number(e.target.value))
                      }
                ...
                {deals.length === 0 ? (
                  ...
                  deals.map((deal, index) => (
                    ...
                    >
                      ...
                      <td className="p-4 text-slate-700 truncate">
                        {deal.model}
                      </td>
                      ...
                      <td className="p-4 text-center">
                        ...
                        <span
                          className={`inline-block font-bold text-sm px-2.5 py-1 rounded-lg ${deal.vfmScore >= 70
